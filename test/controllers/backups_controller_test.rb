...
class BackupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create backup" do
    assert_difference('Backup.count') do
      post backups_url, params: { backup: { cycle: @backup.cycle, path: @backup.path, remark: @backup.remark } }
    end
  ...
  test "should update backup" do
    patch backup_url(@backup), params: { backup: { cycle: @backup.cycle, path: @backup.path, remark: @backup.remark } }
