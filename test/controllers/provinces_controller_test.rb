...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post provinces_url, params: { province: { name: @province.name, polygon: @province.polygon, remark: @province.remark } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { name: @province.name, polygon: @province.polygon, remark: @province.remark } }
