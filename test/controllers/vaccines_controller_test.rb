...
class VaccinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vaccine" do
    assert_difference('Vaccine.count') do
      post vaccines_url, params: { vaccine: { company: @vaccine.company, country: @vaccine.country, des: @vaccine.des, name: @vaccine.name, remark: @vaccine.remark } }
    end
  ...
  test "should update vaccine" do
    patch vaccine_url(@vaccine), params: { vaccine: { company: @vaccine.company, country: @vaccine.country, des: @vaccine.des, name: @vaccine.name, remark: @vaccine.remark } }
