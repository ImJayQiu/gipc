...
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module 'chartkick/chart.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())).use(__webpack_require__(/*! highcharts */ "./node_modules/highcharts/highcharts.js")); // Uncomment to copy all static images under ../images to the output folder and reference
...
*/
(function (X, N) {
  "object" === ( false ? undefined : _typeof(module)) && module.exports ? (N["default"] = N, module.exports = X.document ? N(X) : N) :  true ? !(__WEBPACK_AMD_DEFINE_RESULT__ = (function () {
    return N(X);
  ...
  N(m, "Core/Utilities.js", [m["Core/Globals.js"]], function (f) {
    ...
    function z(b, k) {
      return !!b && "object" === _typeof(b) && (!k || !x(b));
    }
  ...
  N(m, "Core/Renderer/SVG/SVGElement.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Color/Color.js"], m["Core/Globals.js"], m["Core/Utilities.js"]], function (f, h, m, z) {
    ...
    f = function () {
      ...
      E.prototype.shadow = function (a, b, k) {
        ...
        var u;
        !0 === a ? u = q : "object" === _typeof(a) && (u = g(q, a));
    ...
    f = function () {
      ...
      f.prototype.optionsToObject = function (e) {
        var d = {},
            ...
            p = 0,
            n = 0;
        if (v(e) || null === e) d[a[0]] = e;else if (I(e)) for (!c && e.length > l && (g = _typeof(e[0]), "string" === g ? d.name = e[0] : "number" === g && (d.x = e[0]), p++); n < l;) {
          c && "undefined" === typeof e[p] || (0 < a[n].indexOf(".") ? f.prototype.setNestedProperty(d, e[p], a[n]) : d[a[n]] = e[p]), p++, n++;
        } else "object" === _typeof(e) && (d = e, e.dataLabels && (g._hasPointLabels = !0), e.marker && (g._hasPointMarkers = !0));
        return d;
      };
...
/******/ });
//# sourceMappingURL=application-84931f9384d158e1ba11.js.map